...
class SecurityService {
     ...
     * Audit user actions
     */
    async auditUserAction(userId, action, resource, details) {
        try {
    ...
    async isUserBlocked(userId) {
        ...
        try {
            ...
            return {
                ...
                expiresAt: (_a = blockData.expiresAt) === null || _a === void 0 ? void 0 : _a.toDate()
            };
        }
        catch (error) {
    ...
    async getUserPermissions(userId) {
        ...
        if (userData.role === 'premium') {
            permissions.permissions.push('integrations:read', 'integrations:create', 'exports:create', 'ai:access');
            permissions.features.push('advanced_analytics', 'integrations', 'ai_features', 'export_data', 'priority_support');
            permissions.limits = {
                maxTasks: 1000,
                maxProjects: 20,
                maxIntegrations: 5,
        ...
        if (userData.role === 'enterprise') {
            permissions.permissions.push('team:manage', 'admin:read', 'webhooks:create', 'api:access');
            permissions.features.push('team_management', 'advanced_integrations', 'custom_reporting', 'webhook_support', 'api_access', 'priority_support');
            permissions.limits = {
                maxTasks: -1,
                maxProjects: -1,
                maxIntegrations: -1,
    ...
    async logSecurityEvent(userId, action, resource, success, details) {
        try {
    ...
    async logRateLimitViolation(key, rateLimit) {
        try {
