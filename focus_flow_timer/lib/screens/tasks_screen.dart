...
class _TasksScreenState extends State<TasksScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<FirebaseSmartTaskProvider>(
  ...
  void _completeTask(BuildContext context, Task task) {
    final smartTaskProvider = Provider.of<FirebaseSmartTaskProvider>(context, listen: false);
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              final smartTaskProvider = Provider.of<FirebaseSmartTaskProvider>(
                context,
                listen: false,
              );
